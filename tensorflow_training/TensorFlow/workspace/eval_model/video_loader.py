...
out = cv2.VideoWriter('out.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 10, (640,640))
...
while True:
    ...
    track_ids = []
    for classNum in (detections['detection_classes'][0].numpy()).astype(int):
        track_ids.append(labelMapper[classNum])
    ...
    out.write(cv2.resize(image_np_with_detections, (640, 640)))
